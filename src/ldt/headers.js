...
const status2text = {
  ...
  BP: "Best Practice", //Added by LDT, this a specific version of unofficial
  base: "Document",
  finding: "TAG Finding",
...
export function run(conf, doc, cb) {
  conf.isUnofficial = conf.specStatus === "unofficial" || conf.specStatus === "BP";
